...
namespace mole {
    ...
    namespace WindowsMediaFoundation {
        ...
        //=============================================================================
        /** Reads audio from any file format supported by Media Foundation.
         *
         * Metadata values are not supported (see readMetadataFromFile()).
         */
        class Decoder : public juce::AudioFormatReader
        {
            COMLibrary library;
            MFPlatform platform;
            ...
            Decoder (const MediaFormat& mediaFormat, juce::InputStream* stream)
                : AudioFormatReader (stream, mediaFormat.name)
            {
                ...
                if (SUCCEEDED (hr))
                {
                    ...
                    if (SUCCEEDED (hr)) hr = ByteStreamFromInputStream (&byteStream, stream);
            ...
            //=============================================================================
            /** Mono, stereo, 5.1 and 7.1 channel layouts.  */
            juce::AudioChannelSet getChannelLayout() override
            {
                ...
                if (numChannels == 8) return juce::AudioChannelSet::create7point1();
