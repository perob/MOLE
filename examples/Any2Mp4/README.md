...
`Any2Mp4 [OPTIONS] input output`

# DESCRIPTION

C++ example for **mole_audio_formats** module.

Demonstrates how to perform simple audio transcoding.

# OPTIONS

* `--mp4`
    - Transcode to MP4 file format with AAC audio (default).
* `--mp3`
