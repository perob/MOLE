...
Original audio downloaded from freesound.org, distributed under Creative
Commons licenses. These audio files present human speech in studio quality
recordings:
...
Test files were concatenated from original sources, with breath pauses removed.
The test audio is available in mono in 48000 Hz (upsampled from 44100Hz
originals), 44100Hz, 16000Hz, and 8000Hz sampling rate:

* voice-16b-1c-8000hz.wav, voice-16b-1c-16000hz.wav: 20 seconds test audio,
  2 seconds of silence at the start and the end of a file
